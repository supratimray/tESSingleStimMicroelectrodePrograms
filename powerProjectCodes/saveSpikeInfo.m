...
fileSave = fullfile(folderOut, [protocolList '_' expDate 'Cutoff--fr' num2str(cutoffVals(1)) 'snr' num2str(cutoffVals(2)) 'tspk' num2str(cutoffVals(3)) 'absfr' num2str(cutoffVals(4)) '.mat']);
